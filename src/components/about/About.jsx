      ...
      <div className="relative py-28 xl:py-40 w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center">
        <div className="mx-5 md:mx-0 p-8 rounded-xl md:rounded-r-none bg-gray-800 bg-opacity-50 text-white shadow-2xl">
          <h1 className="text-3xl sm:text-5xl font-josefin font-extrabold">
            Dine<span className="text-red-700">Ease</span> <br />
            <span className="text-red-700 text-opacity-80">
              Restaurant
            </span>{" "}
            <br />
            Bangladesh
        ...
        <Link to="/" className="relative m-5 w-full md:w-2/3 lg:w-2/5 inline-flex items-center text-2xl font-firacode text-white font-bold overflow-hidden transition-all duration-300 transform hover:translate-x-4">
        ...
        <div className="absolute top-4 sm:top-auto bottom-auto sm:bottom-20 md:bottom-0 -right-16 md:right-0 h-36 inline-flex md:flex-col justify-around items-center text-yellow-400 transform -translate-x-1/2">
          {/* Twitter */}
          <a href="https://twitter.com/" className="mx-3 transform hover:scale-110">
            <svg
              className="w-7 h-7"
              fill="currentColor"
              role="img"
          ...
          {/* Linkedin */}
          <a href="https://www.linkedin.com/in/zahid-hasan-2434a0279/" className="mx-3 transform hover:scale-110">
            <svg
              className="w-7 h-7"
              fill="currentColor"
              role="img"
          ...
          {/* Google + */}
          <a href="https://myaccount.google.com/u/1/?hl=en&utm_source=OGB&utm_medium=act&pageId=none" className="mx-3 transform hover:scale-110">
            <svg
              className="w-7 h-7"
              fill="currentColor"
